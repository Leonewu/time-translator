...
Tooltip 中的“接案順心!”按钮还藏有一个彩蛋：连续点击时 Tooltip 会进入半透明状态，并在停止点击约 3 秒后缓慢恢复；每次完成 10 秒内点击 10 次都会交替喷出两套紫金几何彩带，文案依次循环显示“🧩 {name}~”、“真的很抱歉...”、“希望看到这里的时候，你今天心情不错。🎉”、“希望你正在过一个普通但舒服的下午”、“希望你今天能看到好看的夕阳🌇和月亮🌙”和“随时 feedback 我，if needs”。长按超过 1 秒会让按钮倾斜颤抖，松手后使用普通蓄力彩带并显示 `接案順心!`。

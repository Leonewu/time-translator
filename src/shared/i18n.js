const MESSAGES = {
  en: {
    ...
    themeToSystem: "Use system appearance",
    ...
    regionRestricted: "Switch to a VPN node outside mainland China/Hong Kong and retry.",
    ...
    modelMenuToggle: "Show available models",
    modelMenuEmpty: "No matching models. Refresh or keep typing.",
    ...
    blockedWebsitesPlaceholder: "e.g. notion.so\nexample.com",
    blockedWebsitesNote: "Optional · disables automatic detection; right-click detection remains available.",
    saveDefault: "Changes save automatically",
    saving: "Saving…",
    saved: "Saved",
    saveFailed: "Save failed",
    magicCodeLabel: "Magic Code",
    magicCodePlaceholder: "Your name",
    magicCodeValid: "VIP code recognized",
    magicCodeUnavailable: "Unavailable",
    feedback: "Feedback",
    ...
    hint_gemini: "Gemini OpenAI-compatible API; use the model list currently available in Google AI Studio.",
    hint_openrouter: "Unified OpenAI-compatible API; refresh the model list and choose a model.",
  ...
  zh: {
    ...
    blockedWebsites: "屏蔽网页",
    blockedWebsitesPlaceholder: "例如：notion.so\nexample.com",
    blockedWebsitesNote: "可选 · 屏蔽自动检测；右键手动检测仍可用。",
    saveDefault: "输入后自动保存",
    saving: "保存中…",
    saved: "已自动保存",
    saveFailed: "保存失败",
    magicCodeLabel: "魔法代码",
    magicCodePlaceholder: "你的名字",
    magicCodeValid: "已识别 VIP 代码",
    magicCodeUnavailable: "暂不可用",
    feedback: "反馈",
    feedbackAria: "发送反馈邮件",
    provider_deepseek: "DeepSeek",
    ...
    hint_gemini: "Gemini OpenAI-compatible 接口；模型名以 Google AI Studio 当前可用列表为准。",
    hint_openrouter: "统一的 OpenAI-compatible 接口；刷新模型列表后选择模型。",
